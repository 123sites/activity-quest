        ...
        <div className="message">
          {loggedIn ? (
            ...
            >
              <div>
                <h4
                  className={`card-header col p-2 m-1 loginTop-${theme} text-center fw-bolder login-card-header`}
                >
                  Login
                </h4>
...
//             <div>
//               <h4
//                 className={`card-header col p-2 m-1 loginTop-${theme} text-center text-light login-card-header`}
//               >
//                 Login
//               </h4>
//               <div className="card-body">
